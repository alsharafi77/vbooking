...
<BODY<%=doLoadcall%>>
 <TABLE style=""><TR><TD>
 <DIV><A class='usesCurrencyCode' HREF="index.jsp" TITLE="Back to the flight booking homepage"><IMG STYLE="float:left; margin-right:9px; margin-left: -2px;" SRC="graphics/new/gh_demo_vb_banner.png" ALT="logo" BORDER="0" /></A></DIV>

<div style="float: right; margin-top: -10px; margin-right: -775px;">
