...
<%
	String _pageTitle = "Paul Vaction Booking online flight booking";
	String city = "";
	String from = "";
	String to = "";
	boolean home = true;
...
<!-- INITIAL GREETINGS AND TRIP BOX -->
		<TD>
			<br><br><br>
			<h1 style="text-indent: 20px; margin-top: -60px;">Welcome to Vacation Booking Friday, the best way to plan your holiday. </h1>
