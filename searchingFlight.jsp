...
if ("h".equals(request.getParameter("tripType"))) {
    RequestDispatcher dispatcher = request.getRequestDispatcher("searchingHotels.jsp");
...
<!-- <script> setTimeout(function(){window.location='book-flight.jsp';}, 2000); </script> -->
...
<TD align="center">
	<DIV style=" margin-left: auto; margin-right: auto;">
		...
		<h1  style= " margin-top: -120px; ">Searching for flights...</h1>
	   	...
	   	<br><br>	
		<h3 style= "font-size:1.6EM; "> <strong style="font-size: 2.5EM;"><%=flyingfrom%> </strong>to <strong style="font-size: 2.5EM;"><%=flyingto%> </strong> on <strong ><%=from%></strong></h3>
	</DIV>
</TD>
