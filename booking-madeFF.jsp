	...
	<TR>
		<TD valign="top">
			<DIV class="new_header">
				<%@ include file="inc-header-no-currencyFF.jsp" %>
			</DIV> 	
...
if (hotelOnly == null) {
   ...
   if (loyaltyPointsParam==null) {
       request.setAttribute("msg", "Missing 'loyaltyPoints' parameter");
       RequestDispatcher dispatcher = request.getRequestDispatcher("errorFF.jsp");
       dispatcher.forward(request, response);
   }           
   ...
   <DIV style=" margin-left: auto; margin-right: auto;">
		...
		<h3 style="font-size: 1.6em;">Your flight reservation number is: <BR><B><SPAN ID="FlightReservationNumber"><%=reservationNumberParam%></SPAN></B></h3>
		 <h3 style="font-size: 1.6em;">You will earn <%=loyaltyPointsParam %> loyalty points for this flight.</h3>
	...
	<DIV CLASS="hotelBook_box">
				...
				<DIV CLASS="banner_manage_flight">
					<img src="graphics/new/gh_demo_banner_fold_blue.png"
						style="float: left; margin-left: -11px;"> <img
						src="graphics/new/banner_point_blue.png"
   	...
   	<DIV style=" margin-left: auto; margin-right: auto;">
		...
		<h3 style="font-size: 1.6em;">Your flight reservation number is: <BR><B><SPAN ID="FlightReservationNumber"><%=reservationNumberParam%></SPAN></B></h3>
	   	...
	   	<img src="graphics/new/gh_demo_flighthotel.png" style="height: 100px; width: 100px;">
	   		<br>
	   	<h1  style= "  FONT-SIZE: 3EM;"><%=confTitle%></h1>
