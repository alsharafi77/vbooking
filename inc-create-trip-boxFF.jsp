...
<form name="tripBookingForm" method="get" action="book-flightFF.jsp" class='usesCurrencyCode' style="width:600">
...
<script language="JavaScript" src="date.js"></script>
	...
	<option class = "default" value="" >From Departing City</option>
	<option class = "set" value="AMS" <% if ("AMS".equals(fFrom)) {%>selected="true"<%} %> >Amsterdam (AMS)</option>
	<option class = "set" value="BLR" <% if ("BLR".equals(fFrom)) {%>selected="true"<%} %> >Bangalore (BLR)</option>
	<option class = "set" value="BCN" <% if ("BCN".equals(fFrom)) {%>selected="true"<%} %> >Barcelona (BCN)</option>
	<option class = "set" value="EDI" <% if ("EDI".equals(fFrom)) {%>selected="true"<%} %> >Edinburgh (EDI)</option>
	<option class = "set" value="STN" <% if ("STN".equals(fFrom)) {%>selected="true"<%} %> >London Stansted (STN)</option>
	</select>
