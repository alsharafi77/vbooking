   ...
   %>	
	<Table class="block" style="">
		<tr><td VALIGN=TOP style="height: 40px;">
			<DIV class="new_header"><A class='usesCurrencyCode' HREF="index.jsp" TITLE="Back to the flight booking homepage"><IMG STYLE="float:left; margin-right:9px;" SRC="graphics/new/gh_demo_vb_banner.png" ALT="logo" BORDER="0" /></A></DIV>
		</td></tr>
		<tr><td valign=top align="center">
			...
			<h4>Return to the main page by clicking <a href="index.jsp">here</a>.</h4>
   			<BR>
   		...
   		<% if (exc!=null) { %>
   			...
   			<DIV ID="details" style="visibility:hidden; text-align: left; margin-left: 100px; margin-right: 100px;">
     			...
     			<P>It occurred at the following place: </P>
     			<PRE>
